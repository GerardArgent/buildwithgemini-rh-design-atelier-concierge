...
def get_memory_service():
    """Process-wide memory service: VertexAiMemoryBankService when configured."""
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or "6969379796983742464"
    project = os.environ.get("GOOGLE_CLOUD_PROJECT") or "qwiklabs-gcp-03-b12e4132c215"
    location = (
